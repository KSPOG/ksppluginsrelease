...
Path('.github/scripts/_temp_branch_seed.txt').unlink(missing_ok=True)
Path('.github/workflows/fix-chopper-resume-same-tree.yml').unlink(missing_ok=True)
Path('.github/scripts/fix_chopper_resume_same_tree.py').unlink(missing_ok=True)
