...
public interface KspBryophytaConfig extends Config
{
    ...
    @ConfigSection(
            name = "Banking & restock",
            description = "Varrock banking, teleport runes and trip supplies",
            position = 1
    )
    ...
    @ConfigSection(
            name = "Survival",
            description = "Health, prayer and poison handling",
            position = 2
    )
    ...
    @ConfigSection(
            name = "Kills & loot",
            description = "Post-kill behaviour",
            position = 3
    )
    ...
    @ConfigItem(
            keyName = "strategy",
            name = "Strategy",
            description = "Choose Melee, Ranged or Fire Magic. The plugin equips the matching default/custom side-panel setup automatically",
            position = 0,
    ...
    @ConfigItem(
            keyName = "fireSpell",
            name = "Fire spell",
            description = "Spell used when Strategy is Magic - Fire",
            position = 1,
            section = strategySection
    )
    ...
    @ConfigItem(
            keyName = "foodName",
            name = "Food",
            description = "Exact food name to withdraw at Varrock East bank",
            position = 0,
    ...
    @ConfigItem(
            keyName = "foodAmount",
            name = "Food amount",
            description = "Food per trip. 21 mirrors the supplied setup while leaving room for teleport runes and loot",
            position = 1,
            section = bankingSection
    )
    ...
    @Range(min = 1, max = 100)
    @ConfigItem(
            keyName = "varrockTeleportCount",
            name = "Varrock teleports",
            description = "Bank enough raw runes for this many Varrock Teleport casts (3 Air + 1 Fire + 1 Law each)",
            position = 2,
            section = bankingSection
    )
    ...
    @ConfigItem(
            ...
            description = "Maintain Protect from Magic while Bryophyta is active",
            position = 0,
    ...
    @ConfigItem(
            ...
            name = "Eat at HP %",
            description = "Eat when health reaches this percentage or lower",
            position = 1,
            section = survivalSection
    )
    ...
    @Range(min = 0, max = 20)
    @ConfigItem(
            keyName = "teleportAtPrayerPoints",
            name = "Teleport at Prayer",
            description = "Varrock teleport and start a bank/altar cycle when Prayer reaches this many points. 0 means when depleted",
            position = 2,
            section = survivalSection
    )
    ...
    @Range(min = 0, max = 10)
    @ConfigItem(
            keyName = "teleportAtFoodCount",
            name = "Teleport at food",
            description = "Varrock teleport and restock when remaining food reaches this amount",
            position = 3,
            section = survivalSection
    )
    ...
    @ConfigItem(
            ...
            name = "Handle poison",
            description = "Use Microbot's anti-poison handling when poison protection is needed",
            position = 4,
            section = survivalSection
    )
    ...
    @ConfigItem(
            ...
            name = "Auto navigate/enter",
            description = "After bank + altar, navigate through the Varrock Sewers and enter Bryophyta's lair",
            position = 0,
            section = lootSection
    )
    ...
    @ConfigItem(
            ...
            name = "Loot boss drops",
            description = "Loot Mossy keys, clue scrolls, ensouled giant heads and items above the configured value",
            position = 1,
            section = lootSection
    )
    ...
    @ConfigItem(
            ...
            name = "Loot value",
            description = "Minimum GE value for generic boss-drop looting. 0 disables value-based looting",
            position = 2,
            section = lootSection
    )
    ...
    @ConfigItem(
            ...
            description = "After a kill, attempt Bryophyta's chest",
            position = 3,
            section = lootSection
    )
    ...
    @ConfigItem(
            ...
            description = "Stop the script if the player dies",
            position = 4,
            section = lootSection
    )
