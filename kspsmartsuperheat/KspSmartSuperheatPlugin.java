...
@PluginDescriptor(
    ...
    description = "Profit-aware Superheat Item with live market selection, informative overlay and Grand Exchange auto-restocking",
    tags = {"superheat", "smithing", "magic", "grand exchange", "money making", "profit"},
    authors = {"KSP"},
    version = KspSmartSuperheatPlugin.VERSION,
...
public class KspSmartSuperheatPlugin extends Plugin
{
    ...
    @Provides
    KspSmartSuperheatConfig provideConfig(ConfigManager configManager)
    {
        return configManager.getConfig(KspSmartSuperheatConfig.class);
    }

    KspSmartSuperheatScript getScript()
    {
        return script;
    }
    ...
    protected void startUp()
    {
        ...
        script.run(config);
        log.info("KSP Smart Superheat v{} started", VERSION);
    }
