...
public class KspKaramjaFishingPlugin extends Plugin
{
    ...
    private final KspMuleWorkerService muleService = new KspMuleWorkerService("Karamja Fishing");

    private long started;
    private int startXp;

    @Provides
    KspKaramjaFishingConfig provideConfig(ConfigManager manager) { return manager.getConfig(KspKaramjaFishingConfig.class); }
