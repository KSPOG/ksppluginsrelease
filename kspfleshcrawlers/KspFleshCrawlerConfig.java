...
public interface KspFleshCrawlerConfig extends Config, KspMuleConfig, KspSupportConfig {
    ...
    default String lootItems() { return "Grimy ranarr weed, Grimy avantoe, Grimy kwuarm, Grimy cadantine, Grimy lantadyme, Nature rune, Dust rune, Fire rune, Iron ore, Silver bar, Coins, Bottom of sceptre, Uncut sapphire, Uncut emerald, Uncut ruby, Uncut diamond, Loop half of key, Tooth half of key"; }
    @Range(min = 1, max = 20)
