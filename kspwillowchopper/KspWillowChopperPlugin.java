...
public class KspWillowChopperPlugin extends Plugin {
    public static final String VERSION="0.1.2"; private static final Pattern ANIMA_BARK_PATTERN=Pattern.compile("You've been awarded <col=[0-9a-f]+>(\\d+) Anima-infused bark</col>\\.");
