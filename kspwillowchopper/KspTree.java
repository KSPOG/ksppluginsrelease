...
/**
 * Tree/resource catalogue used by the Chopper runtime.
 *
 * Object names and actions intentionally match the current Microbot/RuneLite
 * scene names while resource IDs use gameval ItemID constants.
 */
public enum KspTree {
    ...
    KspTree(String displayName, String objectName, String resourceName,
            int resourceId, int woodcuttingLevel, String action) {
