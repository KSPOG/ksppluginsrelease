...
public enum KspTree {
    ...
    LIGHT_JUNGLE("Light jungle", "light jungle", "Thatch spar light", ItemID.THATCH_SPAR_LIGHT, 10, "Chop down"),
    OAK("Oak", "oak tree", "Oak logs", ItemID.OAK_LOGS, 15, "Chop down"),
    MEDIUM_JUNGLE("Medium jungle", "medium jungle", "Thatch spar med", ItemID.THATCH_SPAR_MED, 20, "Chop down"),
    ...
    DENSE_JUNGLE("Dense jungle", "dense jungle", "Thatch spar dense", ItemID.THATCH_SPAR_DENSE, 35, "Chop down"),
    ...
    HOLLOW_TREE("Hollow tree", "hollow tree", "Bark", ItemID.BARK, 45, "Chop down"),
    MAHOGANY("Mahogany", "mahogany tree", "Mahogany logs", ItemID.MAHOGANY_LOGS, 50, "Chop down"),
    ARCTIC_PINE("Arctic pine", "arctic pine", "Arctic pine logs", ItemID.ARCTIC_PINE_LOGS, 54, "Chop down"),
    ...
    SULLIUSCEP("Sulliuscep", "sulliuscep", "Sulliuscep cap", ItemID.SULLIUSCEP_CAP, 65, "Chop down"),
