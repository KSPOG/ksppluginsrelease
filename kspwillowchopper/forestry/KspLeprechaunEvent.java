...
public class KspLeprechaunEvent implements BlockingEvent {
    ...
    @Override public boolean validate(){return plugin.isForestryEventEnabled(KspForestryEvent.LEPRECHAUN)&&Microbot.isPluginEnabled(plugin)&&Microbot.isLoggedIn()&&Microbot.getRs2NpcCache().query().withId(NpcID.GATHERING_EVENT_WOODCUTTING_LEPRECHAUN).nearest()!=null;}
