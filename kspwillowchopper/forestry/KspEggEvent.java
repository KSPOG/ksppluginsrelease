...
public class KspEggEvent implements BlockingEvent {
    ...
    @Override public boolean validate(){return Microbot.isPluginEnabled(plugin)&&Microbot.isLoggedIn()&&Microbot.getRs2NpcCache().query().withId(NpcID.GATHERING_EVENT_PHEASANT_FORESTER).nearest()!=null;}
