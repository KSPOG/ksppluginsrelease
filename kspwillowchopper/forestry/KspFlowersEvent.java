...
public class KspFlowersEvent implements BlockingEvent {
    ...
    @Override public boolean validate(){return Microbot.isPluginEnabled(plugin)&&Microbot.isLoggedIn()&&!Microbot.getRs2NpcCache().query().where(n->n.getName()!=null&&isFloweringBush(n.getId())).toList().isEmpty();}
